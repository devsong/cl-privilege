...
public class IndexController {
    ...
    public String logout(HttpServletRequest request) throws Exception {
        ...
        // 被拦截器拦截处理
        return "redirect:" + configUtil.getCasServerUrl() + "/logout?service="
                + configUtil.getCasServiceUrl();
    }
    ...
    public String modifypassword(String oldpassword, String password, HttpServletRequest request)
            throws Exception {
