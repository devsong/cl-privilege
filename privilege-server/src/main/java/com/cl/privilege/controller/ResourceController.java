...
public class ResourceController {
    ...
    @RequestMapping("/list")
    public String main(String visitedModule, String visitedResource, HttpServletRequest request,
            ModelMap map) {
        // 初始化用户、菜单
    ...
    public String getResourceTree(HttpServletRequest request, HttpServletResponse response,
            ModelMap map) {
    ...
    public String getResourceTreeWithChecked(Integer roleId, HttpServletRequest request,
