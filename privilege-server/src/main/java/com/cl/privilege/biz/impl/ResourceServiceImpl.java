...
public class ResourceServiceImpl implements IResourceService {
    ...
    public Integer createResource(Resource resource, User user) {
        ...
        this.setResourceInsert(resource, user);
    ...
    public Integer updateResourceById(Resource resource, User user) {
        this.setResourceUpdate(resource, user);
    ...
    public String getResourceTree(Integer roleId) {
        Set<Integer> setResource = new HashSet<>();
        ...
        Map<String, Integer> mapModule = new HashMap<>();
        sb.append("[");
        int i = 0;
        for (Module m : moduleList) {
            ...
            i++;
            sb.append("{").append("\"id\":\"").append("m_").append(m.getId()).append("\"")
                    .append(",\"parent\":\"").append("#\"").append(",\"text\":\"")
                    .append(m.getName()).append("\"").append(",\"li_attr\":{\"flag\":\"")
                    .append(m.getFlag()).append("\"}");
            // 前两个级别默认打开
            sb.append(",\"state\":{");
        ...
        for (Resource r : resourceList) {
            ...
            i++;
            sb.append("{").append("\"id\":\"").append(r.getId()).append("\"")
                    .append(",\"parent\":\"")
                    .append(r.getParentId() == 0 ? ("m_" + mapModule.get(r.getModuleFlag()))
                            : r.getParentId())
                    .append("\"").append(",\"text\":\"").append(r.getName()).append("\"")
